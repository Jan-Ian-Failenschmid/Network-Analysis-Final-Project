...
```{r, warning=FALSE}
df_clean <- clean_data("GSS_panel06w123_R6a - SPSS.sav", age_lim = 48)
```
...
latLabels <-  c("Racial Attitudes (RA)", "Gay Attitudes (GA)", "Social Behaviour (SB)",
               "Living Standard (LS)", "Working Mothers (WM)", "Morals (M)",
               "Religiousness (R)","Political Views (PV)", "News Consumption (NC)")

#Manifest Labels
manLabels <- names(df_clean[8:ncol(df_clean)])
